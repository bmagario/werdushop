...
*/
  ...
  self.addNotWorkDate = addNotWorkDate;
...
/*  $scope.$watch('add_shipping_date', function(newValue, oldValue){
  ...
  function addDate(isValid){
    /*var day = $scope.add_shipping_date;
    
    if(isValid){
      
      var id_status = 2;      
      if($scope.enable_day) {id_status = 1;}
      ...
      if(day !== undefined && day !== null && day !== '' &&       
        ...
        var date_new = BasketPDateService.pasarDiaString(day);
       
        BasketPDateService
        .agregarDiaEntrega(day, $scope.basketPS.selected_zone_loc.id_location, $scope.basketPS.selected_zone_loc.id_zone, id_status)
  ...
  function addNotWorkDate(isValid){
    if(isValid){
      /*
      var id_status = 2;      
      if($scope.enable_day) {id_status = 1;}
